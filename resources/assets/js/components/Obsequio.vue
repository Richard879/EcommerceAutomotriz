<template>
    <transition name="slide-fade" appear>
        <main>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h3 class="h4">BUSCAR OBSEQUIOS</h3>
                                                            </div>
                                                            <div class="card-body">
                                                                <form class="form-horizontal">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-9 offset-sm-5">
                                                                            <button type="button" class="btn btn-primary btn-corner btn-sm" @click="buscarObsequio">
                                                                ...
                                                                <template v-if="arrayObsequio.length">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-striped table-sm">
                                                                            ...
                                                                            <tbody>
                                                                                <tr v-for="obsequio in arrayObsequio" :key="obsequio.nIdObsequio">
                                                                                    <td v-text="obsequio.nIdObsequio"></td>
                                                                                    <td v-text="obsequio.cNombreProveedor"></td>
                                                                                    <td v-text="obsequio.cNombreObsequio"></td>
                                                                                    <td v-text="obsequio.dFechaInicio"></td>
                                                                                    <td v-text="obsequio.dFechaFin"></td>
                                                                                    <td v-text="obsequio.fMontoPresupuestoSol"></td>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <template v-else>
                                                                                            <el-tooltip class="item" effect="dark" placement="top-start">
                                                                                                <div slot="content">Activar {{ obsequio.cNombreObsequio }}</div>
                                                                                                <i @click="activar(obsequio.nIdObsequio)" :style="'color:red'" class="fa-md fa fa-square"></i>
                                                                                            </el-tooltip>
                                                                                        </template>
                                                                                    </td>
                                                                                </tr>
                                                                        ...
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <form class="form-horizontal">
                                                                                    <div class="form-group row">
                                                                                        <div class="col-sm-12">
                                                                                            <input type="hidden" v-model="formDistribucion.nidobsequio">
            ...
            <!-- MODAL PROVEEDORES DISTRIBUCION POR EVENTO OBSEQUIOS -->
...
<script>
    export default {
        ...
        methods:{
            ...
            buscarObsequio(){
                this.vistaFormularioTabBuscar = 1;
                this.listarObsequio(1);
            },
            listarObsequio(page){
                this.mostrarProgressBar();
                var url = this.ruta + '/obsequio/GetObsequio';
                axios.get(url, {
                    params: {
                    ...
                    this.arrayObsequio    = response.data.arrayObsequio.data;
                    this.pagination.current_page= response.data.arrayObsequio.current_page;
                    this.pagination.total       = response.data.arrayObsequio.total;
                    this.pagination.per_page    = response.data.arrayObsequio.per_page;
                    this.pagination.last_page   = response.data.arrayObsequio.last_page;
                    this.pagination.from        = response.data.arrayObsequio.from;
                    this.pagination.to          = response.data.arrayObsequio.to;
            ...
            activar(nIdObsequio){
                swal({
                    ...
                    cancelButtonText: 'No, cancelar!'
                        ...
                        if (result.value) {
                            var url = this.ruta + '/obsequio/activar';
                            axios.put(url , {
            ...
            desactivar(nIdObsequio){
                ...
                swal({
                    ...
                    cancelButtonText: 'No, cancelar!'
                        ...
                        if (result.value) {
                            var url = this.ruta + '/obsequio/desactivar';
                            axios.put(url , {
                                nIdObsequio: nIdObsequio
                            }).then(response => {
                                swal(
            ...
            registrar(){
                ...
                var url = this.ruta + '/obsequio/SetObsequio';
                axios.post(url, {
                    nIdEmpresa: parseInt(sessionStorage.getItem("nIdEmpresa")),
                    nIdSucursal: parseInt(sessionStorage.getItem("nIdSucursal")),
                    nIdProveedor: parseInt(this.formObsequio.nidproveedor),
                    ...
                    {
                        this.registrarAsignaDetalle(response.data[0].nIdObsequio)
                        this.registrarAsignaElemento(response.data[0].nIdObsequio);
                        $("#myBar").hide();
                        swal('Obsequio registrado');
                        this.formDistribucion.nidobsequio = response.data[0].nIdObsequio;
                        this.activarTab3();
                    }
                    else{
            ...
            registrarAsignaDetalle(nIdObsequio){
                let me = this;
            ...
            registrarAsignaElemento(nIdObsequio){
            ...
            listarDistribucionElementoVenta(){
                var url = this.ruta + '/obsequio/GetDistribucionByElementoVenta';
                axios.get(url, {
                    params: {
            ...
            validarDistribucion(){
                ...
                if(this.formDistribucion.nidobsequio == 0){
            ...
            limpiarFormulario(){
                ...
                this.formDistribucion.nidobsequio = 0,
