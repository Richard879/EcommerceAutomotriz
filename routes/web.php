...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/solicitudCartaCaracteristica/GeLstCompras', 'CartaCaracteristicaController@GeLstCompras');
    Route::get('/solicitudCartaCaracteristica/GetLstCotizacionAprobadas', 'CartaCaracteristicaController@GetLstCotizacionAprobadas');
    Route::post('/solicitudCartaCaracteristica/SetRegistrarSCC', 'CartaCaracteristicaController@SetRegistrarSCC');
    Route::get('/solicitudCartaCaracteristica/GetLstCartaCaracteristica', 'CartaCaracteristicaController@GetLstCartaCaracteristica');
    Route::get('/solicitudCartaCaracteristica/GetDetalleSolicitud', 'CartaCaracteristicaController@GetDetalleSolicitud');
    Route::put('/solicitudCartaCaracteristica/SetConformeNoConforme', 'CartaCaracteristicaController@SetConformeNoConforme');
    Route::post('/solicitudCartaCaracteristica/SetAprobadoNoAprobado', 'CartaCaracteristicaController@SetAprobadoNoAprobado');
    Route::put('/solicitudCartaCaracteristica/SetAnularSCC', 'CartaCaracteristicaController@SetAnularSCC');
