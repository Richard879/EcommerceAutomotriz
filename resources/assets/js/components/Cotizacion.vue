            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">
                        <vs-divider color="dark">MODULO COTIZACIÓN</vs-divider>
                    </h2>
                </div>
            </header>
                                                                        ...
                                                                        <form class="form-horizontal">
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="row flex-rigth-margin">
                                                                                    <div class="form-group row">
                                                                                        <strong>
                                                                                            TOTAL US$ &nbsp; &nbsp; <label> {{ montoTotalCotizacion = totalConfiCoti }} </label>
                                                                                        </strong>
                                                                                    </div>
                                                                                    <div class="form-group row">
                                                                                        <strong>
    ...
    export default {
        ...
        methods:{
            ...
            paginateCotizacion(data, page){
                ...
                this.arrayCotizaciones      = data.slice(this.pagination.from1, this.pagination.to);
            },
