        ...
        <main>
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">AGINACIÓN VENDEDOR A CUOTA</h2>
                </div>
            </header>
                                            ...
                                            <vs-table max-items="10" pagination :data="arrayFlagVendedoresByIdJV" notSpacer>
                                                ...
                                                <template slot-scope="{data}">
                                                    <vs-tr :key="indextr" v-for="(tr, indextr) in data" >
                                                        ...
                                                        <vs-td :data="data[indextr].cNombreMarca">
                                                            {{data[indextr].cNombreMarca}}
                                                        </vs-td>
                                                        <vs-td :data="data[indextr].cNombreModelo">
                                                            {{data[indextr].cNombreModelo}}
                                                        </vs-td>
                                            ...
                                            <table class="table table-striped table-sm">
                                                ...
                                                <tbody>
                                                    <tr v-for="vendedor in arrayFlagVendedoresByIdJV" :key="vendedor.cParNombre">
                                                        ...
                                                        <td v-text="vendedor.cNombreMarca"></td>
            ...
            llenarArrayVendedoresByIdJV(){
                ...
                me.arrayVendedoresByIdJV.map(function(value, key){
                    me.arrayFlagVendedoresByIdJV.push({
                        nIdAsignacionVendedorModelo : value.nIdAsignacionVendedorModelo,
                        cNombreProveedor            : value.cNombreProveedor,
                        cNombreLinea                : value.cNombreLinea,
                        cNombreMarca                : value.cNombreMarca,
                        cNombreModelo               : value.cNombreModelo,
