            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">
                        <vs-divider color="dark">MODULO AUTORIZACIÓN - ADMINISTRADOR DE JEFE DE VENTAS</vs-divider>
                    </h2>
                </div>
            </header>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab02" href="#TabSolicitudesVendedores" role="tab" @click.prevent="tabSolicitudesVendedores" data-toggle="tab">
                                            <i class="fa fa-search"></i> SOLICITUDES VENDEDORES
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="TabSolicitudesVendedores">
                                        <section class="forms">
                                            <div class="container-fluid">
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form class="form-horizontal">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-9 offset-sm-5">
                                                                        <button type="button" class="btn btn-primary btn-corner btn-sm" @click.prevent="buscarSolicitudesVendedores(1)">
                                                                            <i class="fa fa-search"></i> Buscar
                                                                        </button>
                                                                        <button type="button" class="btn btn-default btn-corner btn-sm" @click.prevent="limpiarMisSolicitudes()">
                                                                            <i class="fa fa-recycle"></i> Limpiar
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form class="form-horizontal">
                                                                <div class="col-lg-12">
                                                                    <template v-if="arraySolicitudesVendedores.length">
                                                                        <div class="table-responsive">
                                                                            <table class="table table-striped table-sm">
                                                                                <thead>
                                                                                    <tr>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr v-for="carta in arraySolicitudesVendedores" :key="carta.nIdSolicitudAutorizacion">
                                                                                        <td v-text="carta.cFechaSolicitud"></td>
                                                                                        <td v-text="carta.cTipoSolicitud"></td>
                                                                                        <td v-text="carta.cNroSolicitud"></td>
                                                                                        <td v-text="carta.cContacto"></td>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <a href="#" v-if="carta.cFlagEstadoAutorizacionControl =='P '"
                                                                                                        @click="abrirModal('pediente', 'abrir', carta);">
    ...
    export default {
        ...
        data(){
            return {
                ...
                arrayMisSolicitudes : [],
                // =============================================================
                // VARIABLES SOLICITUDES VENDEDORES
                // =============================================================
                arraySolicitudesVendedores: [],
        ...
        methods: {
            ...
            tabMisSolicitudes(){
                ...
                $('#TabSolicitudesVendedores').removeClass('in active show');
            ...
            // =================================================================
            // METODOS TAB SOLICTIDUES VENDEDORES
            // =================================================================
            tabSolicitudesVendedores(){
                $('#tab01').removeClass('nav-link active');
                ...
                $('#TabSolicitudesVendedores').addClass('in active show');
                $('#TabNuevaSolicitud').removeClass('in active show');
                this.limpiarMisSolicitudes();
                this.llenarEstados();
            ...
            buscarSolicitudesVendedores(page){
                ...
                axios.get(url, {
                    ...
                    let info = response.data.arrayMisSolicitudes;
                    this.arraySolicitudesVendedores     = info.data;
                    this.pagination.current_page =  info.current_page;
                    this.pagination.total        = info.total;
                    this.pagination.per_page     = info.per_page;
                    this.pagination.last_page    = info.last_page;
            ...
            getDetalleSolicitud(data, modalidad){
                ...
                if(op == 2){
                    this.$nextTick().then(function () {
                        me.accionConformeNoConforme(1, 2);//Enviar Conforme por defecto
                    })
                }
            },
            accionConformeNoConforme(data, op){
                ...
                axios.put(url, {
                    ...
                    'nIdEstadoSolicitudAutorizacion': (data == 1) ? 1300238 : 1300239,
                    ...
                    'modalidadRecibirData' : op//Si es 1 es porque la acción viene del Modal de Aprobación de Vendedores, sino es registro de Autorización del JV
                }).then(response => {
