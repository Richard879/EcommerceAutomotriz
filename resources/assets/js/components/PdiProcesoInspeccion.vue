                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="hidden" v-model="formPdi.nidproveedor">
                                                        <input type="text" v-model="formPdi.cproveedornombre" disabled="disabled" class="form-control form-control-sm">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <el-select v-model="formPdi.nidclase" filterable placeholder="Select" >
                                                        <el-option
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <el-select v-model="formPdi.nidsubclase" filterable placeholder="Select" >
                                                        <el-option
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <el-select v-model="formPdi.nidlinea" filterable placeholder="Select" v-on:change="llenarComboMarca()">
                                                        <el-option
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <el-select v-model="formPdi.nidmarca" filterable placeholder="Select" v-on:change="llenarComboModelo()">
                                                        <el-option
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <el-select v-model="formPdi.nidmodelo" filterable placeholder="Select" >
                                                        <el-option
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="hidden" v-model="formPdi.nidversionveh">
                                                    <input type="text" v-model="formPdi.cnombrecomercial" @keyup.enter="buscarVersionVehiculo()" class="form-control form-control-sm" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>-->
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <label class="col-sm-4 form-control-label">* Modelo</label>
                                                <div class="col-sm-8">
                                                    <el-select v-model="formPdi.nidmodelo" filterable placeholder="Select" v-on:change="llenarComboModelo()">
                                                        <el-option
                                                        v-for="item in arrayModelo"
                                                        :key="item.nIdPar"
                                                        :label="item.cParNombre"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="hidden" v-model="formPdi.nidversionveh">
                                                    <input type="text" v-model="formPdi.cnombrecomercial" class="form-control form-control-sm" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>-->
        ...
        methods:{
            ...
            llenarComboLinea(){
                ...
                axios.get(url, {
                    params: {
                        'nidempresa' : 1300011,
                        'nidproveedor' : this.formPdi.nidproveedor
                    }
                }).then(response => {
                    this.arrayLinea = response.data;
                    if(this.vistaFormulario){
                        this.formPdi.nidlinea = 0;
                    }
            ...
            llenarComboMarca(){
                ...
                axios.get(url, {
                    params: {
                        'nidlinea' : this.formPdi.nidlinea
                    }
                }).then(response => {
                    this.arrayMarca = response.data;
                    if(this.vistaFormulario){
                        this.formPdi.nidmarca = 0;
                    }
                    this.arrayModelo = [];
            ...
            llenarComboModelo(){
                ...
                axios.get(url, {
                    params: {
                        'nidmarca' : this.formPdi.nidmarca
                    }
                }).then(response => {
                    this.arrayModelo = response.data;
                    if(this.vistaFormulario){
                        this.formPdi.nidmodelo = 0;
                    }
                }).catch(error => {
                    console.log(error);
                });
            ...
            asignarProveedor(nProveedorId, cProveedorNombre){
                this.formPdi.nidproveedor = nProveedorId;
                this.formPdi.cproveedornombre = cProveedorNombre;
                this.cerrarModal();
                this.arrayMarca = [];
                this.arrayModelo = [];
            ...
            validarBusqueda(){
                this.error = 0;
                this.mensajeError =[];
                if(this.formPdi.nidproveedor == 0){
            ...
            listarVersionVehiculo(page){
                ...
                axios.get(url, {
                    params: {
                        'nidempresa' : 1300011,
                        'nidproveedor' : this.formPdi.nidproveedor,
                        'nidclase' : this.formPdi.nidclase,
                        'nidsubclase' : this.formPdi.nidsubclase,
                        'nidlinea' : this.formPdi.nidlinea,
                        'nidmarca' : this.formPdi.nidmarca,
                        'nidmodelo' : this.formPdi.nidmodelo,
                        'cnombrecomercial' : this.formPdi.cnombrecomercial.toString(),
                        'page' : page
                    }
                }).then(response => {
            ...
            registrar(){
                ...
                axios.post(url, {
                    nIdEmpresa: 1300011,
                    nIdProveedor: parseInt(this.formPdi.nidproveedor),
                    nIdClase: parseInt(this.formPdi.nidclase),
                    nIdSubClase: parseInt(this.formPdi.nidsubclase),
                    nIdLinea: parseInt(this.formPdi.nidlinea),
                    nIdMarca: parseInt(this.formPdi.nidmarca),
                    nIdModelo: parseInt(this.formPdi.nidmodelo),
                    cNombreComercial: this.formPdi.cnombrecomercial.toUpperCase().toString()
                }).then(response => {
            ...
            actualizar(){
                ...
                axios.post(url, {
                    nIdVersionVeh: parseInt(this.formPdi.nidversionveh),
                    nIdEmpresa: 1300011,
                    nIdProveedor: parseInt(this.formPdi.nidproveedor),
                    nIdClase: parseInt(this.formPdi.nidclase),
                    nIdSubClase: parseInt(this.formPdi.nidsubclase),
