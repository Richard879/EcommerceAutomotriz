                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#TabBuscaWFinanciero" @click="tabBuscarEventoCampania();" role="tab" data-toggle="tab">
                                ...
                                <!--<li class="nav-item">
                                    <a class="nav-link" href="#TabAsignaDistribucion" @click="TabAsignaDistribucion();" role="tab" data-toggle="tab">
                            ...
                            <div class="tab-content">
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <form class="form-horizontal">
                                                                                <div class="col-sm-12">
                                                                                    <div class="row">
                                                                                        <label class="col-sm-3 form-control-label">* ELEMENTO VENTA</label>
                                                                                        <div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="input-group">
                                                                                                        ...
                                                                                                        <select name="account" v-model="formDistribucion.ntipoproveedor" class="form-control form-control-sm">
                                                                                ...
                                                                                <template v-if="arrayProveedorPorEC.length">
                                                                                    <div class="table-responsive">
                                                                                        <table class="table table-striped table-sm">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr v-for="(proveedor, index) in arrayProveedorPorEC" :key="proveedor.nIdProveedor">
                                                                                                    <td>
                                                                                                    ...
                                                                                                    <table class="table table-striped table-sm">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr v-for="(eledist, index) in arrayElementoDistribucion" :key="eledist.nIdEventoElementoVenta">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div class="input-group">
                                                                                                                        <input type="hidden" v-model="formDistribucion.nentidad">
                                                                                                                        <input type="text" v-model="formDistribucion.cproveedornombre" class="form-control form-control-sm" readonly>
                                                                                                                        <div class="input-group-prepend">
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input type="number" v-model="formDistribucion.fValorPorcentual" class="form-control form-control-sm">
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </tbody>
                                                                                                    </table>                                    
                                ...
                                <!--<div role="tabpanel" class="tab-pane fade" id="TabAsignaDistribucion">
                                </div>-->
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods:{
            ...
            listarElementos(page){
                var url = this.ruta + '/elemento/GetElementoByTipo?nidempresa=' + 130011 
            ...
            cargarDistPorElementoVenta(){
                var url = this.ruta + '/ec/GetDistribucionByElementoVenta?nideventocampania=' +  800016;
            ...
            asignarProveedorPorElementoVenta(nIdProveedor, cProveedorNombre){
                var valor = this.formDistribucion.nindex;
                this.formDistribucion.nentidad = nIdProveedor;
                this.formDistribucion.cproveedornombre= cProveedorNombre;
            },
            ...
            registrarAsignaDistribucion(){
                if(this.formDistribucion.ntipodistribucion==1){
                    ...
                    if(this.arrayElementoDistribucion.length > 0){
                        ...
                        axios.post(url, {
                            nIdEventoCampania: 800016,
                            data: this.arrayElementoDistribucion,
                            nIdUsuario: 190011
                        }).then(response => {
                            //this.registrarAsignaDetalle(response.data);
                        }).catch(error => {
