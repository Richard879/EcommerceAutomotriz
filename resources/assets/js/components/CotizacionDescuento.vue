            ...
            <header class="page-header">
                <div class="container-fluid">
                    <vs-divider color="dark">
                        <h2 class="no-margin-bottom">MODULO DISTRIBUCIÓN DESCUENTO COTIZACIÓN</h2>
                    </vs-divider>
                </div>
            </header>
    ...
    export default {
        ...
        methods: {
            ...
            buscarCotizacionesPendientes(page){
                ...
                var url = this.ruta + '/gescotizacion/GetLstCotizacionConDescuento';
                axios.get(url, {
                    params: {
                        'nidempresa'    : parseInt(sessionStorage.getItem("nIdEmpresa")),
                        'nidsucursal'   : parseInt(sessionStorage.getItem("nIdSucursal")),
            ...
            registrarDistribucion(){
                ...
                axios.post(url, {
                    ...
                    if (this.cflagVerificaDistribucionAprobacion) {
                        // GENERAR LA CONFORMIDAD HACIA EL GERENTE DE VENTAS
                        this.cambiarEstadoCotizacion(response.data, 4);
                        swal('Pedido distribuido y pendiente de aprobación por Gerente de Ventas');
                    } else {
