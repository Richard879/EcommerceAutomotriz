    ...
    <main>
        <header class="page-header">
          <div class="container-fluid">
            <h2 class="no-margin-bottom"> AUOTIZACIÓN</h2>
          </div>
        </header>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab01" href="#TabMisSolicitudes" role="tab" data-toggle="tab">
                                        <i class="fa fa-search"></i> MIS SOLICITUDES
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab02" href="#TabNuevaSolicitud" role="tab" data-toggle="tab">
                                        <i class="fa fa-list-alt"></i> NUEVO SOLICITUD
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <section class="forms">
                                        <div class="container-fluid">
                                            <div class="col-lg-12">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="tab0201" href="#TabDatosSolictud" role="tab" data-toggle="tab">
